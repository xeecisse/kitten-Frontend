    ...
    >
      ...
      <Row>
        <Col className="offset-md-2" md={8}>
          ...
          >
            <CardHeader style={{}}>Login</CardHeader>
            <CardBody>
          ...
          />
                ...
                <div className="my-2">
                  <Button
                    style={{
                      width: '100%',
                      backgroundColor: 'rgb(35, 13, 54)',
                      border: 'none',
                    }}
                    className="mt-2"
                  >
                    Continue witch Google
                  </Button>
                  <Button
                    style={{
                      width: '100%',
          ...
          />
                ...
                <Col md={{ size: '6', offset: '9' }}>
                  <Button
                    className="mt-2"
                    color="success"
                    onClick={() => navigate('/general-models')}
                    style={{
                      backgroundColor: 'rgb(35, 13, 54)',
                      border: 'none',
                      width: '50%',
